// 페이지와 지점 메타를 한 곳에서 관리함.
export const pageMeta = {
  main: {
    title: "전체",
    description: "개인정보 동의 인원, 세션 건수, 부위별 수집 현황을 통합 확인하는 관리자 화면입니다.",
  },
  jangdeok: {
    title: "이끌림(장덕점)",
    description: "이끌림(장덕점) 지점의 수집 현황만 별도로 확인하는 관리자 화면입니다.",
  },
  hyocheon: {
    title: "이끌림(효천점)",
    description: "이끌림(효천점) 지점의 수집 현황만 별도로 확인하는 관리자 화면입니다.",
  },
  company: {
    title: "AIM",
    description: "AIM 지점의 수집 현황만 별도로 확인하는 관리자 화면입니다.",
  },
};
